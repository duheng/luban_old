module.exports = {
    ...
    // luban src entry, also inner webpack entry, default to `src/pages/index.js`
    base: "src",
    ...
    static: {
        ...
        test: "",
        pre: "http://static.maoyan.com/", // here use CDN domain
        gray: "http://static.maoyan.com/", // here use CDN domain
        release: "http://static.maoyan.com/" // here use CDN domain
    },
    ...
    api: {
        ...
        test: "",
        pre: "http://wx.maoyan.com", // online api base entry
        gray: "http://wx.maoyan.com", // online api base entry
        release: "http://wx.maoyan.com"
    },
